...
public class StringList {
	...
	public boolean equal(StringList l){
	    ...
	    do {
	        result = Objects.equals(thisNode.getElement(), otherNode.getElement());
	        if (!result) {
	            break;
            }
        } while ((thisNode = thisNode.getNext()) != null && (otherNode = otherNode.getNext()) != null);
	...
	public StringList reverse(){
	    ...
	    while (node != null) {
	        newList.addFront(node.getElement());
	        node = node.getNext();
        }
